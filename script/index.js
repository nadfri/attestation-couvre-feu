...
function affichage_Attestation(tab) {
    ...
    for (let user of tab.listNom) {
        ...
        fieldset.innerHTML = `
        <h1>ATTESTATION DE DÉPLACEMENT DÉROGATOIRE ENTRE 18H ET 6H</h1>
        <h2>
        ...
        1.Déplacements entre le domicile et le lieu d’exercice de l’activité professionnelle ou un établissement d’enseignement ou de formation, déplacements professionnels ne pouvant être différés.</p>
